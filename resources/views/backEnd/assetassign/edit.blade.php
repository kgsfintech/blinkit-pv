            ...
            <div class="card mb-4">
                <div class="card-header" style="background:#37A000">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-6">
                            <h6 style="color: white" class="fs-17 font-weight-600 mb-0">Edit Finance</h6>
						 </div>
						<div class="col-md-6">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('assetassign.update', $finance->id)}}"  enctype="multipart/form-data">
                        @method('PATCH') 
                        @csrf            
                        @component('backEnd.components.alert')

                        @endcomponent   
                    @include('backEnd.assetassign.form')
                </form>
                    <hr class="my-4">
