        ...
        <div class="col-md-12 col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif --}}
                    <form method="post" action="{{ url('it/update')}}" enctype="multipart/form-data">
                        @csrf
                       ...
                       <div class="row row-sm">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="example-date-input" name="amount" value="" class="form-control"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="font-weight-600">Assigned </label>
                                <select class="form-control" name="teammember_id"
                                @if(Request::is('client/*/edit'))> <option disabled
                                style="display:block">Please Select One</option>
                    
                                @foreach($teammember as $accountData)
                                <option value="{{$accountData->id}}"
                                @if(($client->leadpartner) == $accountData->id) selected @endif>
                                    {{ $accountData->title->title }}. {{ $accountData->team_member }}</option>
                                @endforeach
                                ...
                                <option value="{{$accountData->id}}">
                                    {{ $accountData->team_member }}</option>
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="font-weight-600">Issue</label>
                                   <textarea rows="3" name="problem" value="" class="form-control"
                                        placeholder="Enter Issue"></textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="font-weight-600">Solution</label>
                                    <textarea rows="3" name="solution" value="" class="centered form-control"  id="editor"
