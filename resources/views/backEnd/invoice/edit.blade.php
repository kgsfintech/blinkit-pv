            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="col-md-6">
                            <h6 class="fs-17 font-weight-600 mb-0">Edit Invoice</h6>
                        </div>
						<div class="col-md-2">
							<p style="float: right;"><a data-toggle="modal" data-target="#exampleModal1" ><b>Log</b></a></p>
                        </div>
						<div class="col-md-4">
							<p style="float: right;"><b>Created by : </b>{{ $invoice->teammember->team_member }} ( {{ $invoice->teammember->role->rolename }} )</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Invoice log</h5>
                    <div>
                        <ul>
