            ...
            <div class="card mb-4">
                <div class="card-header" style="background: #37A000;">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 style="color: white" class="fs-17 font-weight-600 mb-0">Edit creditnote</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('creditnote.update', $creditnote->id)}}"  enctype="multipart/form-data">
                        @method('PATCH') 
                        @csrf            
                        @component('backEnd.components.alert')

                        @endcomponent   
                    @include('backEnd.creditnote.form')
                </form>
                    <hr class="my-4">
