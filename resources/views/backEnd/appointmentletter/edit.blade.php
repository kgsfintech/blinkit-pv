            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">Edit appointmentletter</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('appointmentletter.update', $appointmentletter->id)}}"  enctype="multipart/form-data">
                        @method('PATCH') 
                        @csrf            
