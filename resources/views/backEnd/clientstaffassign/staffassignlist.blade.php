 ...
 <th>Assigned</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td><b>{{$clientsDatas->client_name }}</b></td>
                           @php
                                    $staffassignsDatas = DB::table('staffassigns')
            ->leftjoin('teammembers','teammembers.id','staffassigns.staff_id')
            ->where('staffassigns.client_id',$clientsDatas->id)->select('teammembers.team_member')->get();
                  
                         @endphp
                             <td>@foreach($staffassignsDatas as $staffassignsDatas) 
                                 <span class="badge badge-pill badge-primary">{{ $staffassignsDatas->team_member ??''}} </span>
            ...
            <div class="modal-body">
                    ...
                    <div class="details-form-field form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            ->where('teammembers.role_id', 15)->select('teammembers.id','teammembers.team_member','roles.rolename')->get();
                           // dd($teammember);
                            @endphp
