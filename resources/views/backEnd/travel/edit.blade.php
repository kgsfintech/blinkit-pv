            ...
            <div class="card mb-4">
                <div class="card-header" style="background: #37A000;">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 style="color: white" class="fs-17 font-weight-600 mb-0">Edit Travel</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="modal-header" style="background:#37A000">
                    <h5 style="color:white;" class="modal-title font-weight-600" id="exampleModalLabel4">Attachment</h5>
                    <div>
                        <ul>
              ...
              <div class="modal-body">
                    <div class="table-responsive">
                        ...
                        <table class="table display table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                @foreach($travel->travelattachment as $travelattachmentdata)
                              <tr>
                                  <td><a  href="{{ url('backEnd/image/travel/'.$travelattachmentdata->attachment) }}"> {{ $travelattachmentdata->attachment ??''}}</a></td>
                                  <td>{{ date('F d,Y', strtotime($travelattachmentdata->created_at)) }}   {{ date('h:i A', strtotime($travelattachmentdata->created_at)) }}</td>
                              </tr>
                                @endforeach
                            </tbody>
                        </table>
