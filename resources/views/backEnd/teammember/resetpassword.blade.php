            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">Reset Member Password</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="@if(Request::is('resetpassword/*'))
                    {{ url('password/update/'.$id) }} @endif" enctype="multipart/form-data">
                        @csrf
