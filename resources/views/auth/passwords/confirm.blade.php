            ...
            <div class="panel" style="background:#37A000;">
             ...
             @endif
              <div class="register-logo text-center mb-4">
                ...
                <form  method="POST" action="{{url('newpassowrd/store/'.$id)}}">
                    @csrf
                    <div>
                    ...
                    <div class="form-group">
                        <input type="password" name="password" class="form-control @error('email') is-invalid @enderror" required placeholder="Enter Password" >
                    ...
                    <div class="form-group">
                        <input type="password" name="confirm_password" class="form-control @error('email') is-invalid @enderror" required placeholder="Enter Confirm Password" >
