 ...
 <script data-cfasync="false" src="cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{ url('backEnd/plugins/jQuery/jquery-3.4.1.min.js')}}"></script>
