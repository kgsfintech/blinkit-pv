            ...
            <div class="card mb-4">
                <div class="card-header" style="background:#37A000">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 style="color: white" class="fs-17 font-weight-600 mb-0">Reset Client Password</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="@if(Request::is('client/clientuserlogin/resetpassword/*'))
                    {{ url('client/clientuserlogin/password/update/'.$id) }} @endif" enctype="multipart/form-data">
                        @csrf
