<div class="row row-sm">
    <div class="col-12">
           <div class="form-group">
               ...
               <input id="questions" readonly name="question" style="width:90%;border: 1px solid #FFFFFF;" type="text">
           </div>
       </div>
...
<div class="col-sm-4">
   <input class="form-control" name="particular" type="text">
</div>
...
<div class="col-sm-4">
  ...
  <input  id="ilrid"  class="form-control"   name="id" value="{{ $id ??''}}" type="text">
</div>
<div class="col-sm-8"></div>
</div> 
<div class="details-form-field form-group row">
