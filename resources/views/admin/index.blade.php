@extends('admin.layouts.layout') @section('admin_content')
                ...
                <div class="card-body text-center">
                    <div class="row justify-content-center">
                        <div class="greet-user col-12 col-xl-10">
                            <img src="{{ url('backEnd/dist/img/happiness.svg')}}" alt="..." class="img-fluid  mb-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <div
                        ...
                        <div class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">Latest
                            Feedback</div>
                        <i class="fas fa fa-smile opacity-25 fa-5x text-warning decorative-icon"></i>
                        <div class="d-flex">
                            <div>
                                <img class="d-block rounded-circle" width="32"
                                    src="{{ url('backEnd/dist/img/avatar-5.jpg')}}">
                            </div>
                            <div class="pl-3">
                                Nothing bad to say<br> at this point ðŸ˜Œ
                                <a class="d-block mt-1 small opacity-75"
                                    href="cdn-cgi/l/email-protection.html#c6aea3b4aba7a8b5b2a7b4afada9b086a1aba7afaae8a5a9ab">Write
                                    back</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <div class="d-flex flex-column p-3 mb-3 bg-white shadow-sm rounded">
                        <div class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">avg time on
                            site</div>
                        ...
                        <table class="table display table-bordered table-striped table-hover bg-white m-0 card-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip"
                                                title="Melissa Ayre">
                                                <img src="{{ url('backEnd/dist/img/avatar-1.jpg')}}"
                                                    class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip"
                                                title="Karen Robinson">
                                                <img src="{{ url('backEnd/dist/img/avatar-2.jpg')}}"
                                                    class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip"
                                                title="Miyah Myles">
                                                <img src="{{ url('backEnd/dist/img/avatar-3.jpg')}}"
                                                    class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip"
                                                title="Daniela Dewitt">
                                                <img src="{{ url('backEnd/dist/img/avatar-4.jpg')}}"
                                                    class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
                                    ...
                                    <td>Noakhali</td>
                                    <td>
                                        <a href="#" class="btn btn-success-soft btn-sm mr-1"><i
                                                class="far fa-eye"></i></a>
                                        <a href="#" class="btn btn-danger-soft btn-sm"><i
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip"
                                                title="Daniela Dewitt">
                                                <img src="{{ url('backEnd/dist/img/avatar-5.jpg')}}"
                                                    class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
