...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Basic Initialization</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Data Tables Basic Initialization</h1>
                <small>Advanced interaction controls in any HTML table. <a href="https://datatables.net/" target="_blank">https://datatables.net/</a></small>
            </div>
        </div>
    </div>
</div>
