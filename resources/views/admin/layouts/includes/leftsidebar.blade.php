  ...
  <nav class="sidebar sidebar-bunker">
    <div class="sidebar-header">
        ...
        <a href="index.html" class="logo"><img src="{{ url('backEnd/image/kgsomani.png')}}" alt=""></a>
    </div><!--/.sidebar header-->
    <div class="profile-element d-flex align-items-center flex-shrink-0">
        <div class="avatar online">
            <img src="{{ url('backEnd/dist/img/avatar-1.jpg')}}" class="img-fluid rounded-circle" alt="">
        </div>
        <div class="profile-text">
            <h6 class="m-0">Naeem Khan</h6>
            <span><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="016479606c716d6441666c60686d2f626e6c">[email&#160;protected]</a></span>
        </div>
    </div><!--/.profile element-->
